...
class Xception_CIFAR(BasicModule):
    def __init__(self, block=Block, num_blocks=None, num_classes=10):
        super(Xception_CIFAR, self).__init__()
        self.model_name = 'xception_cifar'
        if num_blocks == None:
            num_blocks = [3, 3, 3]
        self.in_planes = 64
