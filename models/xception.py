...
class Xception(BasicModule):
    def __init__(self, num_classes=10):
        ...
        self.block3=Block(256,512,3,1,start_with_relu=True,grow_first=True)
        ...
        self.block6=Block(512,728,2,2,start_with_relu=True,grow_first=False)

        self.conv3 = SeparableConv2d(728,1024,3,1,1)
        self.bn3 = nn.BatchNorm2d(1024)

        #do relu here
        self.conv4 = SeparableConv2d(1024,512,3,1,1)
        self.bn4 = nn.BatchNorm2d(512)
        self.apool = nn.AvgPool2d(4, stride=1)
