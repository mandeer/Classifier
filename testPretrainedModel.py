...
def main(config):
    ...
    # model
    model = getattr(models, config.model)(depth=18)
    print(model)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='ResNet', help='train, test')
    parser.add_argument('--model-name', type=str,
                        default='./pretrained_models/models_pretrained/resnet18-5c106cde.pth', help='model for test')
